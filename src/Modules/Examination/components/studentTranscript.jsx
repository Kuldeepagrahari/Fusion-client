      ...
      <table style={styles.table}>
        <thead>
          <tr>
            ...
            {studentData.semesterPerformance.map((sem) => (
              <th style={styles.th} key={sem.semester}>
                {sem.semester}
              </th>
            ))}
        ...
        <tbody>
          <tr>
            <td style={styles.td}>SPI</td>
            {studentData.semesterPerformance.map((sem) => (
              <td style={styles.td} key={sem.semester}>
                {sem.spi}
              </td>
            ))}
            <td style={styles.td} />
          ...
          <tr>
            <td style={styles.td}>CPI</td>
            {studentData.semesterPerformance.map((sem) => (
              <td style={styles.td} key={sem.semester}>
                {sem.cpi}
              </td>
            ))}
            <td style={styles.td}>{studentData.finalCPI}</td>
          </tr>
        </tbody>
      </table>
